        ...
        <div class="flex-1 overflow-y-auto">
            <div class="flex flex-col items-center justify-center h-full text-center text-gray-600 text-3xl p-5">
                ...
                <p class="mt-4 text-lg text-gray-500 text-left leading-relaxed">
                    ...
                    By selecting an AI agent, you’re taking a step towards optimizing your operations and simplifying
                    your workflow. Explore our options and discover how our solutions can transform your tasks into
                ...
                <h3 class="text-lg font-semibold mt-5 dark:text-white-light">Select an AI Agent to Begin</h3>
            </div>
        </div>
    </div>
</template>
