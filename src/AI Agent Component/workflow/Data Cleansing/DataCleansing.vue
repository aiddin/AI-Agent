                ...
                <div class="panel">
                    ...
                    <div class="space-y-4">
                        ...
                        <div v-if="imagePreview" class="mt-4">
                            <img :src="imagePreview" alt="Uploaded ID Document"
                                class="w-full rounded-lg border border-[#e0e6ed] dark:border-[#1b2e4b]" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div v-else-if="results.dob && results.dob.error"
                                    class="bg-danger-light p-4 rounded-lg border border-danger">
                    ...
                    <div class="panel">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div v-else-if="results.nric && results.nric.error"
                                    class="bg-danger-light p-4 rounded-lg border border-danger">
                    ...
                    <div class="panel">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div v-else-if="results.address && results.address.error"
                                    class="bg-danger-light p-4 rounded-lg border border-danger">
